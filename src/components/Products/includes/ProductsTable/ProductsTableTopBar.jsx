...
export default function ProductsTableTopBar(props) {
    return (
                        ...
                        <Dropdown.Menu>
                            ...
                            <label className="dropdown-item st-checkbox d-inline-flex cursor-pointer">
                                <input
                                    type="checkbox"
                                    className="d-none"
                                    defaultChecked={props.column__ProductName}
                                    onChange={ev => {
                                        (ev.target.checked) ? props.setColumn__ProductName(true) : props.setColumn__ProductName(false)
                                    }} />
                            ...
                            <label className="dropdown-item st-checkbox d-inline-flex cursor-pointer">
                                <input
                                    type="checkbox"
                                    className="d-none"
                                    defaultChecked={props.column__ProductImg}
                                    onChange={ev => {
                                        (ev.target.checked) ? props.setColumn__ProductImg(true) : props.setColumn__ProductImg(false)
                                    }} />
                                <span className="box d-flex align-items-center justify-content-center border">
                                    <FeatherIcon
                                        icon="check"
                            ...
                            <label className="dropdown-item st-checkbox d-inline-flex cursor-pointer">
                                <input
                                    type="checkbox"
                                    className="d-none"
                                    defaultChecked={props.column__ProductSKU}
                                    onChange={ev => {
                                        (ev.target.checked) ? props.setColumn__ProductSKU(true) : props.setColumn__ProductSKU(false)
                                    }} />
                                <span className="box d-flex align-items-center justify-content-center border">
                                    <FeatherIcon
                                        icon="check"
                                ...
                                <span className="text ms-2">SKU</span>
                            </label>
                            ...
                            <label className="dropdown-item st-checkbox d-inline-flex cursor-pointer">
                                <input
                                    type="checkbox"
                                    className="d-none"
                                    defaultChecked={props.column__ProductStatus}
                                    onChange={ev => {
                                        (ev.target.checked) ? props.setColumn__ProductStatus(true) : props.setColumn__ProductStatus(false)
                                    }} />
                                <span className="box d-flex align-items-center justify-content-center border">
                                    <FeatherIcon
                                        icon="check"
