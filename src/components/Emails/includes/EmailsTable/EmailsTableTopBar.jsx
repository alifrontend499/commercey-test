...
export default function EmailsTableTopBar(props) {
    return (
        <div className="inner d-flex">
            {/* lt */}
            <div className="lt">
                <Link
                    to="/settings/emails/create"
                        ...
                        <Dropdown.Menu>
                            ...
                            <label className="dropdown-item st-checkbox d-inline-flex cursor-pointer">
                                <input
                                    type="checkbox"
                                    className="d-none"
                                    defaultChecked={props.column__TemplateName}
                                    onChange={ev => {
                                        (ev.target.checked) ? props.setColumn__TemplateName(true) : props.setColumn__TemplateName(false)
                                    }} />
                            ...
                            <label className="dropdown-item st-checkbox d-inline-flex cursor-pointer">
                                <input
                                    type="checkbox"
                                    className="d-none"
                                    defaultChecked={props.column__Subject}
                                    onChange={ev => {
                                        (ev.target.checked) ? props.setColumn__Subject(true) : props.setColumn__Subject(false)
                                    }} />
                                <span className="box d-flex align-items-center justify-content-center border">
                                    <FeatherIcon
                                        icon="check"
                            ...
                            <label className="dropdown-item st-checkbox d-inline-flex cursor-pointer">
                                <input
                                    type="checkbox"
                                    className="d-none"
                                    defaultChecked={props.column__to}
                                    onChange={ev => {
                                        (ev.target.checked) ? props.setColumn__to(true) : props.setColumn__to(false)
                                    }} />
                                <span className="box d-flex align-items-center justify-content-center border">
                                    <FeatherIcon
                                        icon="check"
                                ...
                                <span className="text ms-2">To</span>
                            </label>
                            ...
                            <label className="dropdown-item st-checkbox d-inline-flex cursor-pointer">
                                <input
                                    type="checkbox"
                                    className="d-none"
                                    defaultChecked={props.column__DateAdded}
                                    onChange={ev => {
                                        (ev.target.checked) ? props.setColumn__DateAdded(true) : props.setColumn__DateAdded(false)
                                    }} />
                                <span className="box d-flex align-items-center justify-content-center border">
                                    <FeatherIcon
                                        icon="check"
                                ...
                                <span className="text ms-2">Date Added</span>
                            </label>
                        </Dropdown.Menu>
                    </Dropdown>
                </div>
